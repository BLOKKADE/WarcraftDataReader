...
public class ObjectWc3DataMerger(
    TxtDataReader textReader,
    MetaDataReader metaReader,
    ObjectDataReader dataReader) : BaseWc3DataMerger
{
    ...
    protected override void Merge(Wc3Object targetObject, Wc3Object sourceObject)
    {
        ...
        {
            var targetField = targetObject.Fields.FirstOrDefault(x => x.FieldName == sourceField.FieldName);
            if (targetField == null)
            {
